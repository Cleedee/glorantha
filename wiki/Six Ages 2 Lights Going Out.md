...
- **Publicadora:** Kitfox Games
- **Lançamento:** 21 de agosto de 2023
- **Plataformas:** macOS, Windows, iOS

### Recepção
- **Metacritic (iOS):** "Aclamação universal"
- **Rock Paper Shotgun:** "Bestest Best" — "faz parte de uma série única de jogos que proporcionam uma riqueza de histórias pensativas e divertidas que mostram como um mundo de fantasia pode evoluir"
- **Siliconera:** "pode ser bastante cativante", melhora o jogo anterior sem mudar muito a interface
- **Pocket Gamer:** "uma experiência narrativa fenomenal baseada em escolhas", excelente propaganda do mundo de Glorantha
- **TouchArcade:** "um verdadeiro vencedor", o jogo mais acessível ambientado em Glorantha até o momento
