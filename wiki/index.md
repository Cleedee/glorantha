...
# Índice Mestre — Glorantha

> Este índice é a ferramenta primária de navegação. Atualizado a cada ingestão.

---

## Entidade
> Deuses, heróis, figuras históricas, NPCs importantes
...
## Conceito
> Ideias abstratas, mecânicas de jogo, cosmologia
...
| [[Hsunchen]] | Povos totêmicos animais; não distinguem humanos de animais tribais; Uncolings (povo das renas); Hykim e Mikyh | `Hsunchen` `animal totem` `Uncoling` `Fronela` `reencarnação` | draft |
...
## Fonte
> Referências externas, livros, artigos, materiais de origem

| Página | Resumo | Tags | Status |
|--------|--------|------|--------|
| [[Trollpak]] | Suplemento Chaosium (1982) sobre cultura troll; contém regras do Trollball | `troll` `suplemento` `1982` | draft |
...
| [[Sandheart]] | Série de aventuras Jonstown; Jon Webb; 4 volumes. Vol 1: Tales of the Sun County Militia (39p, hazia, plinths Genert, wyter Beaky). Vol 2: The Corn Dolls (sandbox investigativo Cliffheath, ~50 NPCs). Vol 3: Tradition (89p, framework campanha, Dark Watch Cave, 4 testes, heroquest). Vol 4: The God Skin & Mad Prax | `Jonstown` `aventura` `Prax` `Sun County` | draft |
...
## Cultura
> Povos, tribos, nações, organizações sociais
...
> Páginas que ainda precisam ser classificadas
