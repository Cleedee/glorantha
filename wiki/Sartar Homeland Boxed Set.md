...
- **Leika Blacksper** — work in progress revelado (2021).
- **Sartar Faces** — ilustração mostrando a diversidade de aparência e estilo dos sartaritas (para capítulo de moda).
...
- Afastamento deliberado de terminologia nórdica ("cottar, carl, godi, thralls").
...
- [ ] Quantas páginas tem o capítulo de moda sartarita?
- [ ] O gráfico de organização tribal será incluído como handout?
